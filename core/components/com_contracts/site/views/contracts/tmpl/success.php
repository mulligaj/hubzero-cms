...
<section class="main section">
	<h3 class="success">Thank you for your interest!</h3>
	<p>An email will be sent to <strong><?php echo $this->row->email; ?></strong> with an electronic copy of the agreement.</p>
