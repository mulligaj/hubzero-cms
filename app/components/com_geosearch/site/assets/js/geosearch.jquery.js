	...
	loadMarkers: function()
	{
		...
		function(data)
		{
			...
			$.each(markers, function(index, marker)
			{
				...
				{
					case "member":
						var icon = "/app/components/com_geosearch/site/assets/img/icn_member.png";
						break;
					case "event":
						var icon = "/app/components/com_geosearch/site/assets/img/icn_event.png";
						break;
					case "job":
						var icon = "/app/components/com_geosearch/site/assets/img/icn_job.png";
						break;
					case "organization":
